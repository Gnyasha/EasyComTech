<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditDeveloper.aspx.cs" Inherits="EasyComTech.EditDeveloper" %>
    ...
    <div id="Tabs" role="tabpanel">
        ...
        <div class="tab-content" style="padding-top: 20px">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <asp:CheckBoxList ID="chkHours" runat="server" CssClass="form-group">
                                        <%--  <asp:ListItem Value="1" Text="&nbsp; Up to 4 hours per day / Até 4 horas por dia" />
                                        <asp:ListItem Value="2" Text="&nbsp; 4 to 6 hours per day / De 4 á 6 horas por dia" />
                                        <asp:ListItem Value="3" Text="&nbsp; 6 to 8 hours per day /De 6 á 8 horas por dia" />
                                        <asp:ListItem Value="4" Text="&nbsp; Up to 8 hours a day (are you sure?) / Acima de 8 horas por dia (tem certeza?)" />
                                        <asp:ListItem Value="5" Text="&nbsp; Only weekends / Apenas finais de semana" />--%>
                                    </asp:CheckBoxList>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <asp:CheckBoxList ID="chkDayTime" runat="server" CssClass="form-group">
                                        <%--  <asp:ListItem Value="1" Text="&nbsp; Morning (from 08:00 to 12:00) / Manhã (de 08:00 ás 12:00)" />
                                        <asp:ListItem Value="2" Text="&nbsp; Afternoon (from 1:00 p.m. to 6:00 p.m.) / Tarde (de 13:00 ás 18:00)" />
                                        <asp:ListItem Value="3" Text="&nbsp; Night (7:00 p.m. to 10:00 p.m.) /Noite (de 19:00 as 22:00)" />
                                        <asp:ListItem Value="4" Text="&nbsp; Dawn (from 10 p.m. onwards) / Madrugada (de 22:00 em diante)" />
                                        <asp:ListItem Value="5" Text="&nbsp; Business (from 08:00 a.m. to 06:00 p.m.) / Comercial (de 08:00 as 18:00)" />--%>
                                    </asp:CheckBoxList>
            ...
            <div role="tabpanel" class="tab-pane" id="Knowledge">
                ...
                <div class="row" style="padding: 10px">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                <asp:Button ID="btnUpdateSkill" Text="Update Skill" OnClick="btnUpdateSkill_Click" class="btn btn-primary btn-lg " runat="server" />
                            </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            ...
                                            <asp:Button ID="btnDownloadPledge" CssClass="btn btn-info btn-sm upload-btn" runat="server" CausesValidation="false" CommandName="SelectSkill"
                ...
                <div class="row">
                    <div class="col-md-2">
                        <asp:Button ID="btnUpdate" Text="Update" class="btn btn-primary btn-lg " OnClick="btnUpdate_Click" runat="server" />
                    </div>
                </div>
